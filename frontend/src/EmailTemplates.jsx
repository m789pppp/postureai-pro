...
export function welcomeEmail({ name, tier = "professional", lang = "en" }) {
  ...
  const content = isAr ? `
    ...
    <div class="feature-row"><div class="feature-icon">🧠</div><div class="feature-text"><div class="feature-title">طبقة الذكاء الاصطناعي</div><div class="feature-desc">ملخصات تنفيذية، تحليل إرهاق، وتوصيات مخصصة — مدعومة بالذكاء الاصطناعي</div></div></div>
  ...
  ` : `
    ...
    <div class="feature-row"><div class="feature-icon">🧠</div><div class="feature-text"><div class="feature-title">AI Intelligence Layer</div><div class="feature-desc">Executive summaries, fatigue analysis, and personalised recommendations — powered by Corvus AI</div></div></div>
...
export function weeklyReportEmail({ name, avgScore = 0, sessCount = 0, trendPct = 0, fatigueLevel = 0, topRec = "", lang = "en" }) {
  ...
  const content = isAr ? `
    ...
    <p>إليك ملخص أداء وضعيتك هذا الأسبوع، مدعوم بتحليل Corvus AI.</p>
    <div class="kpi-grid">
  ...
  ` : `
    ...
    <p>Here's your weekly posture performance summary, powered by Corvus AI analysis.</p>
    <div class="kpi-grid">
...
export function hrMonthlySummaryEmail({ managerName, orgName, teamAvg = 0, teamSize = 0, highRiskCount = 0, sickDayChange = 0, lang = "en" }) {
  ...
  const content = isAr ? `
    ...
    <p>إليك ملخص أداء صحة القوى العاملة لشهر ${new Date().toLocaleDateString("ar-EG", { month: "long", year: "numeric" })}, مدعوم بتحليل Corvus AI.</p>
    <div class="kpi-grid">
  ...
  ` : `
    ...
    <p>Here's your workforce health performance summary for ${new Date().toLocaleDateString("en-US", { month: "long", year: "numeric" })}, powered by Corvus AI analysis.</p>
    <div class="kpi-grid">
