...
async function downloadPDF(sessionOverride, isClinical=false){
  ...
  if(page==="home") return(
    <ErrorBoundary key="page-home">
      ...
      {showWorkforceAnalytics&&(isAdmin||isHRAdmin)&&<ErrorBoundary key="workforce"><Suspense fallback={null}><WorkforceAnalytics uid={profile?.uid} profile={profile} sessions={userSessions} allUsers={allUsers} cs={cs} lang={lang} onClose={()=>setShowWorkforceAnalytics(false)}/>}</Suspense></ErrorBoundary>}
