...
export class ErrorBoundary extends Component {
  ...
  render() {
    ...
    return (
      <div style={{ minHeight: "100dvh", background: "#0d1a2e", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "system-ui,-apple-system,sans-serif", padding: 24 }}>
