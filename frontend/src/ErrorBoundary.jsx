...
export class ErrorBoundary extends Component {
  ...
  render() {
    ...
    return (
      <div style={{ position: "fixed", inset: 0, zIndex: 100010,   /* above the toast layer (100000) — a crash outranks everything */ overflowY: "auto", minHeight: "100dvh", background: "#030b14", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "system-ui,-apple-system,sans-serif", padding: 24 }}>
