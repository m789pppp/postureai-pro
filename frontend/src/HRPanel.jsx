...
export function HRPanel({ user, profile, companyId: cid, cs, t, addToast, onBack, lang="en" }) {
  ...
  if(loading) return (
    <div style={{minHeight:"100dvh",background:"#0d1a2e",display:"flex",alignItems:"center",justifyContent:"center",color:"#f0f6ff",fontFamily:"'Inter',system-ui"}}>
  ...
  if(!companyId) return (
    <div style={{minHeight:"100dvh",background:"#0d1a2e",display:"flex",alignItems:"center",justifyContent:"center",color:"#f0f6ff",fontFamily:"'Inter',system-ui",padding:24}}>
  ...
  return (
    <div dir={isAr?"rtl":"ltr"} style={{minHeight:"100dvh",background:"#0d1a2e",color:"#f0f6ff",fontFamily:"'Inter',system-ui,sans-serif"}}>
      <style>{`@keyframes spin{to{transform:rotate(360deg)}}`}</style>
