...
export default function TrendChart({ sessions = [], cs, lang, onClose, effectiveTier, onUpgrade }) {
  ...
  if (data.days.filter(d => d.avg !== null).length === 0) {
    return (
      <div style={{ position:"fixed",inset:0,zIndex:1800,background:"rgba(0,0,0,.55)",backdropFilter:"blur(12px)",display:"flex",alignItems:"center",justifyContent:"center",padding:20 }}>
  ...
  return (
    <div style={{ position:"fixed",inset:0,zIndex:1800,background:"rgba(0,0,0,.55)",backdropFilter:"blur(14px)",display:"flex",alignItems:"center",justifyContent:"center",padding:16,overflowY:"auto" }}>
