...
const COPY = {
  en: {
    ...
    pricing: {
      ...
      b2cPlans: [
        { id:"starter",      name:"Starter",      price:0,    color:"#6366f1",
          features:["5 sessions/month","Core health tracking","Score history & trends"] },
        { id:"professional", name:"Professional",  price:499,  color:"#0891b2", popular:true,
          features:["Unlimited sessions","Gemini AI Coach","Clinical PDF export","Burnout risk tracking","Priority support"] },
        { id:"elite",        name:"Elite",         price:999,  color:"#10b981",
          features:["Everything in Professional","AI executive summaries","Predictive health forecasting","API access","Clinical-grade reports"] },
      ],
      b2bPlans: [
  ...
  ar: {
    ...
    pricing: {
      ...
      monthly:"شهري", yearly:"سنوي", save:"وفّر 17%",
      ...
      b2cPlans: [
        { id:"starter",      name:"ستارتر",     price:0,    color:"#6366f1",
          features:["5 جلسات/شهر","تتبع الصحة الأساسي","سجل النقاط والاتجاهات"] },
        { id:"professional", name:"احترافي",     price:499,  color:"#0891b2", popular:true,
          features:["جلسات غير محدودة","مدرب Gemini AI","تصدير PDF السريري","تتبع خطر الإرهاق","دعم أولوية"] },
        { id:"elite",        name:"إيليت",       price:999,  color:"#10b981",
          features:["كل مزايا الاحترافي","ملخصات تنفيذية AI","توقع صحة مستقبلي","وصول API","تقارير سريرية"] },
      ],
      b2bPlans: [
