...
const B2B_PAID_PLANS = [
  ...
  },
  {
    ...
    features: {
      en: ["Unlimited employees", "Everything in Growth", "AI clinical narrative", "SAML SSO (Azure AD/Okta) — set up with our team", "White-label branding", "API access", "Dedicated success manager"],
      ar: ["موظفون غير محدودون", "كل مزايا جروث", "تحليل سردي بالذكاء الاصطناعي", "SAML SSO (Azure AD/Okta) — بإعداد من فريقنا", "علامة تجارية White-label", "وصول API", "مدير نجاح مخصص"],
    },
  },
];
