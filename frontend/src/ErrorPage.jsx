...
export function NotFound({ onHome, lang="en" }) {
  const isAr = lang==="ar";
  return (
    <div dir={isAr?"rtl":"ltr"} style={{minHeight:"100dvh",background:"#030b14",display:"flex",alignItems:"center",justifyContent:"center",padding:24,fontFamily:"'IBM Plex Sans Arabic','Inter',system-ui,sans-serif",color:"#f0f6ff",textAlign:"center"}}>
