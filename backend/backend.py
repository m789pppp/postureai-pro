...
# Pure-math scoring primitives now live in scoring_utils.py — imported here
# so backend.py and the test suite share the exact same implementation
# instead of the tests maintaining their own hand-copied duplicate.
from scoring_utils import (
    dist2d_sq, angle_vert, angle_horiz, angle_3pt, angle_3pt_3d, score_m,
)
